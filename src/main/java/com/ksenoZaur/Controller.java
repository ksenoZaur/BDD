...
import static com.ksenoZaur.BDD.primaryStage;
...
//    public static sample.Controller self;
    ...
    public void initialize() {
        ...
        List<String> patternsList = this.generator.getPatterns();
        ...
        List<String> languagesList = this.generator.getLanguages();
    ...
    public void createWindow(ActionEvent actionEvent) {
        ...
        try {
            ...
            img = new Image(new File("src/main/resources/com.ksenoZaur/img/" +
